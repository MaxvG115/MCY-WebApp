...
class AcademicProgramsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create academic_program" do
    assert_difference('AcademicProgram.count') do
      post academic_programs_url, params: { academic_program: { name_academic_program: @academic_program.name_academic_program } }
    end
  ...
  test "should update academic_program" do
    patch academic_program_url(@academic_program), params: { academic_program: { name_academic_program: @academic_program.name_academic_program } }
