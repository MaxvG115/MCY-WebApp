...
class ScholarshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scholarship" do
    assert_difference('Scholarship.count') do
      post scholarships_url, params: { scholarship: { beca_base: @scholarship.beca_base, nombre_beca: @scholarship.nombre_beca } }
    end
  ...
  test "should update scholarship" do
    patch scholarship_url(@scholarship), params: { scholarship: { beca_base: @scholarship.beca_base, nombre_beca: @scholarship.nombre_beca } }
